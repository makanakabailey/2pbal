      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 gap-6 sm:gap-8">
          ...
          <div>
            ...
            <ul className="space-y-1 sm:space-y-2 text-gray-400 text-sm sm:text-base">
              <li><Link href="/" className="hover:text-lime-primary transition-colors">About Us</Link></li>
              <li><Link href="/" className="hover:text-lime-primary transition-colors">Case Studies</Link></li>
              <li><Link href="/" className="hover:text-lime-primary transition-colors">Careers</Link></li>
              <li><Link href="/quote" className="hover:text-lime-primary transition-colors">Contact</Link></li>
            </ul>
          </div>
          <div>
            <h3 className="text-white font-semibold mb-3 sm:mb-4 text-sm sm:text-base">Contact</h3>
            <ul className="space-y-1 sm:space-y-2 text-gray-400 text-sm sm:text-base">
              <li className="break-all">hello@2pbal.com</li>
        ...
        <div className="border-t border-gray-600 mt-8 sm:mt-12 pt-6 sm:pt-8 text-center text-gray-400">
          <p className="text-xs sm:text-sm">&copy; 2025 2Pbal. All rights reserved. | Privacy Policy | Terms of Service</p>
        </div>
      </div>
    </footer>
  );
