        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          {filteredServices.length === 0 && (
            <div className="text-center py-12">
              <p className="text-gray-medium text-lg">No services found matching your criteria.</p>
              <Button
                onClick={() => {
                  setSearchTerm('');
      ...
      <section className="py-16 bg-gray-light">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-8">
            <h2 className="text-3xl font-bold mb-4 text-gray-dark">Create Your Custom Package & Save</h2>
            <p className="text-xl text-gray-medium">Bundle 3+ services and save up to 20%</p>
          </div>
